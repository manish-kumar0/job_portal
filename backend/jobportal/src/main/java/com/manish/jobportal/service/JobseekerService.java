...
import com.manish.jobportal.dto.EducationDTO;
import com.manish.jobportal.dto.ProjectDTO;
import com.manish.jobportal.dto.jobseeker.ProfileDTO;
        ...
        try {
            ...
            if (documents != null && !documents.isEmpty()) {
                for (MultipartFile file : documents) {
                    ...
                    String fileUrl = fileStorageService.uploadFile(file, "jobportal/education/certificate/");
    ...
    public ResponseEntity<?> addCertificate(HttpServletRequest request, String data, MultipartFile documents) {
        ...
        try {
            ...
            try {
                ...
                if (documents != null && !documents.isEmpty()) {
                    String fileUrl = fileStorageService.uploadFile(documents, "jobportal/certification/");
                    Documents doc = Documents.builder()
    ...
    public ResponseEntity<?> updateProfile(
        ...
        try {
            ...
            if (profileImage != null && !profileImage.isEmpty()) {
                String fileUrl = fileStorageService.uploadFile(profileImage, "jobportal/user/profileImage");
